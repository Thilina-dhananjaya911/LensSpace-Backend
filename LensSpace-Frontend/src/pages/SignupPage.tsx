...
import { Camera, Mail, Lock, User, Loader2, AlertCircle } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Normally, backend returns user data, and you could auto-login here.
  ...
  return (
    <div className="flex-1 flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-900 relative">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/4 -left-1/4 w-96 h-96 bg-blue-600/10 blur-3xl rounded-full" />
        <div className="absolute -bottom-1/4 -right-1/4 w-96 h-96 bg-emerald-600/10 blur-3xl rounded-full" />
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-2">Join the community of passionate photographers.</p>
        </div>
